...
class TestLoggingDecorators(unittest.TestCase):
    ...
    def test_splunk_update_ack_file_logged(self):
        ...
        with (  # noqa: E999
            ...
            patch(
                "update_ack_file.get_next_queued_file_details", return_value=False
            ) as mock_get_next_queued_file
        ):  # noqa: E999
            result = lambda_handler(generate_event(messages), context={})
        ...
        mock_get_next_queued_file.assert_called_once()
        mock_change_audit_table_status_to_processed.assert_called_once()
