# TODO Delete Superceded by new converter -
import json
...
def convert_to_flat_json(resource_json, operation):
    ...
    flat_dict = {
        ...
        "PERSON_GENDER_CODE": gender_map.get(
            next(
                (
        ...
        "VACCINATION_PROCEDURE_CODE": resource_json.get("extension", [{}])[0]
        .get("valueCodeableConcept", {})
        .get("coding", [{}])[0]
        .get("code", None),
        "VACCINATION_PROCEDURE_TERM": resource_json.get("extension", [{}])[0]
        .get("valueCodeableConcept", {})
        .get("coding", [{}])[0]
        .get("display", None),
