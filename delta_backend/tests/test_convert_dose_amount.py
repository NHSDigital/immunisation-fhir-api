...
class TestDoseAmountTypeUriToFlatJson(unittest.TestCase):
    ...
    def _run_dose_amount_test(self, expected_uri):
        """Helper function to run the test"""
        self.converter = Converter(json.dumps(self.request_json_data))
        flat_json = self.converter.run_conversion()
        self.assertEqual(flat_json.get("DOSE_AMOUNT"), expected_uri)
    ...
    def test_dose_amount_value_exists(self):
        ...
        self._run_dose_amount_test(expected_uri=0.5)
    ...
    def test_dose_amount_value_missing(self):
        ...
        self._run_dose_amount_test(expected_uri="")
