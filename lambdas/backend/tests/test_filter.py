...
class TestFilter(unittest.TestCase):
    ...
    def setUp(self):
        self.covid_immunization_event = load_json_data("completed_covid_immunization_event.json")
    ...
    def test_add_use_to_identifier(self):
        ...
        excepted_output = deepcopy(self.covid_immunization_event)
    ...
    def test_filter_search(self):
        ...
        unfiltered_imms = deepcopy(self.covid_immunization_event)
