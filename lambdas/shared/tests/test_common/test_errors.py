...
from src.common.models.constants import Constants
from src.common.models.errors import request_with_retry_backoff
...
class TestRaiseErrorResponse(unittest.TestCase):
    ...
    @patch("src.common.models.errors.logger")
    def test_400_raises_bad_request_error(self, mock_logger):
        ...
        with self.assertRaises(errors.BadRequestError) as ctx:
            errors.raise_error_response(response)
