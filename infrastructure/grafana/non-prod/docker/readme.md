...
2. Pull the Docker image back to your local environment.
   `docker pull _{account_id}.dkr.ecr.{region}.amazonaws.com/imms-{env}-grafana-app:11.0.0-22.04_stable_`
3. Run the Docker image in your local environment.
   `docker run -p 3000:3000 _{account_id}.dkr.ecr.{region}.amazonaws.com/imms-{env}-grafana-app:11.0.0-22.04_stable_`
