    ...
    if use_default_app:
        ...
        if vaxx_type_perms:
            ...
            app.add_attribute(
                ...
                "flu:create,covid:create,mmr:create,hpv:create,covid:update,flu:read,covid:read,flu:delete,"
                "covid:delete,mmr:delete,flu:search,covid:search,mmr:search,rsv:create,rsv:search,rsv:update,"
                "rsv:read,rsv:delete",
            )
