...
def create_extension(url: str, stringValue: str = None, idValue: str = None) -> ExtensionItem:
    return ExtensionItem(url=url, valueString=stringValue, valueId=idValue)
...
def build_location_identifier() -> Location:
    return Location(identifier=LocationIdentifier(system="https://fhir.nhs.uk/Id/ods-organization-code", value="X99999"))
        ...
        Performer(
            actor=Reference(
                ...
                identifier=Identifier(
                    ...
                    period=Period(start="2000-01-01", end="2025-01-01"),
                ),
