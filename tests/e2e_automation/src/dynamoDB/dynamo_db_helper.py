...
def fetch_immunization_events_detail(
...
def fetch_immunization_events_detail_by_IdentifierPK(
    aws_profile_name: str,
    IdentifierPK: str,
    env: str,
):
...
def validate_audit_table_record(
    context,
    item,
    expected_status: str,
...
def validate_imms_delta_record_with_batch_record(context, batch_record, item, event_type, action_flag):
    ...
    fields_to_compare = [
        ...
        (
            ...
            event.get("PERSON_GENDER_CODE"),
        ),
        (
            "VACCINATION_PROCEDURE_CODE",
            batch_record["VACCINATION_PROCEDURE_CODE"],
            event.get("VACCINATION_PROCEDURE_CODE"),
        ),
        (
            "VACCINATION_PROCEDURE_TERM",
        ...
        (
            "PERFORMING_PROFESSIONAL_SURNAME",
            batch_record["PERFORMING_PROFESSIONAL_SURNAME"],
            event.get("PERFORMING_PROFESSIONAL_SURNAME"),
        ),
        (
            "PERFORMING_PROFESSIONAL_FORENAME",
...
def validate_to_compare_batch_record_with_event_table_record(context, batch_record, created_event):
        ...
        fields_to_compare.extend(
            [
                ...
                (
                    ...
                    response_patient.identifier[0].system,
                ),
            ]
        )
    ...
    if batch_record["VACCINATION_PROCEDURE_TERM"]:
        fields_to_compare.append(
            (
                "extension.valueCodeableConcept.coding.extension.valueString",
                batch_record["VACCINATION_PROCEDURE_TERM"],
                created_event.extension[0].valueCodeableConcept.coding[0].display,
            )
        )
        ...
        fields_to_compare.extend(
            [
                ...
                (
                    ...
                    created_event.site.coding[0].display,
                ),
            ]
        )
        ...
        fields_to_compare.extend(
            [
                ...
                (
                    ...
                    created_event.vaccineCode.coding[0].display,
                ),
            ]
        )
        ...
        fields_to_compare.extend(
            [
                ...
                (
                    ...
                    created_event.route.coding[0].display,
                ),
            ]
        )
    ...
    if batch_record["DOSE_SEQUENCE"]:
        ...
        fields_to_compare.append(
            (
                "protocolApplied.doseNumberNotProvided",
                "Dose sequence not recorded",
                created_event.protocolApplied[0].doseNumberString,
            )
        )
        ...
        if batch_record["PERFORMING_PROFESSIONAL_FORENAME"]:
            fields_to_compare.append(
                (
                    ...
                    batch_record["PERFORMING_PROFESSIONAL_SURNAME"],
                    p_names["Practitioner.name.family"],
                )
            )
    ...
    fields_to_compare.extend(
        [
            ...
            (
                ...
                created_event.extension[0].url,
            ),
            (
                "extension.valueCodeableConcept.coding.code",
                batch_record["VACCINATION_PROCEDURE_CODE"],
                created_event.extension[0].valueCodeableConcept.coding[0].code,
            ),
            (
            ...
            (
                ...
                created_event.performer[0].actor.identifier.value,
            ),
            (
                "performer.actor.identifier.system",
                batch_record["SITE_CODE_TYPE_URI"],
                created_event.performer[0].actor.identifier.system,
            ),
        ]
    )
