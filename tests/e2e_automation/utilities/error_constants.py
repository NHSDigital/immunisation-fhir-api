ERROR_MAP = {
    ...
    "invalid_DiseaseType": {
        "code": "INVALID",
        "diagnostics": "-immunization.target must be one or more of the following: 3IN1, 4IN1, 6IN1, BCG, COVID, FLU, HEPB, HIB, HPV, MENACWY, MENB, MMR, MMRV, PERTUSSIS, PNEUMOCOCCAL, ROTAVIRUS, RSV, SHINGLES",
    },
    "invalid_DateFrom": {
        "code": "INVALID",
