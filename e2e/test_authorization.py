...
from utils.constants import valid_nhs_number1, cis2_user, nhs_login_user
...
class TestNHSLoginAuthorization(ImmunizationBaseTest):
    my_app: ApigeeApp
    my_imms_api: ImmunisationApi
    ...
    def make_app(self, permissions: Set[Permission]):
        ...
        app_res_auth = NHSLoginAuthentication(get_auth_url(), app_res_cfg, LoginUser(username=nhs_login_user))
        base_url = get_service_base_path()
