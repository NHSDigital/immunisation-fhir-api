...
class TestApplicationRestrictedAuthorization(ImmunizationBaseTest):
    ...
    def test_get_imms_unauthorised(self):
        ...
        self.make_app(perms)
        # When
        response = self.my_imms_api.get_immunization_by_id(
            "id-doesn't-matter", expected_status_code=403
        )
        # Then
    ...
    def test_update_imms_unauthorised(self):
        ...
        self.make_app(perms)
        # When
        response = self.my_imms_api.update_immunization(
            "doesn't-matter", {}, expected_status_code=403
        )
        # Then
        self.assertEqual(response.status_code, 403, response.text)
    ...
    def test_update_imms_unauthorised_2(self):
        ...
        # When
        response = self.my_imms_api.update_immunization(
            imms_id, imms, expected_status_code=403
        )
        # Then
        self.assertEqual(response.status_code, 403, response.text)
    ...
    def test_delete_imms_unauthorised(self):
        ...
        self.make_app(perms)
        # When
        response = self.my_imms_api.delete_immunization(
            "doesn't-matter", expected_status_code=403
        )
        # Then
        self.assertEqual(response.status_code, 403, response.text)
    ...
    def test_search_imms_unauthorised(self):
        ...
        # When
        response = self.my_imms_api.search_immunizations(
            valid_nhs_number1, VaccineTypes.mmr, expected_status_code=403
        )
        # Then
        self.assertEqual(response.status_code, 403, response.text)
...
class TestCis2Authorization(ImmunizationBaseTest):
    ...
    def test_get_imms__unauthorised_vaxx(self):
        ...
        # When
        response = self.my_imms_api.get_immunization_by_id(
            imms_id, expected_status_code=403
        )
        # Then
        self.assertEqual(response.status_code, 403, response.text)
