...
class TestE2EBatch2(unittest.TestCase):
    ...
    if environment != "ref":
        ...
        def test_file_name_validation_error(self):
            ...
            input_file = generate_csv("PHYLIS", "0.3", action_flag="CREATE", file_key=True, offset=OFFSET)
        ...
        def test_header_name_validation_error(self):
            ...
            input_file = generate_csv("PHYLIS", "0.3", action_flag="CREATE", headers="NH_NUMBER", offset=OFFSET)
        ...
        def test_end_to_end_speed_test_with_100000_rows(self):
            ...
            input_file = generate_csv_with_ordered_100000_rows(OFFSET)
